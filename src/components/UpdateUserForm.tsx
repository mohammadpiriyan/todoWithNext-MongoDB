  ...
  return (
    <div>
      ...
      >
        ...
        <button className="flex justify-center text-base w-2/6 bg-yellow-400 text-white px-4 py-2 border rounded-md hover:bg-gray-50 hover:border-yellow-500 hover:text-yellow-800">
          Update
          <span>
